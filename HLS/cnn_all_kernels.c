...
//---------------------------------------------------------------------------------y = -1
		...
		y_coor = center_y - 1;
		x_coor = center_x - 2;
		temp6 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x - 1;
		temp7 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x;
		temp8 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x + 1;
		temp9 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x + 2;
		temp10 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];
		...
		y_coor = center_y;
		x_coor = center_x - 2;
		temp11 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x - 1;
		temp12 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x;
		temp13 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x + 1;
		temp14 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x + 2;
		temp15 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];
		...
		y_coor = center_y + 1;
		x_coor = center_x - 2;
		temp16 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x - 1;
		temp17 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x;
		temp18 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x + 1;
		temp19 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x + 2;
		temp20 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];
		...
		y_coor = center_y;
		x_coor = center_x - 2;
		temp21 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x - 1;
		temp22 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x;
		temp23 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x + 1;
		temp24 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];

		x_coor = center_x + 2;
		temp25 = param->weights[lyr][img][kernel][((y + pad_zeros) * kernel_x) + (2 + pad_zeros)] *
				param->output[lyr][img][IN_C * y_coor + x_coor];
